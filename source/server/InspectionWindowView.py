...
class ClientInspectorView(QMainWindow):
    ...
    def setupUi(self, ClientInspectionWindow):
        ...
        self.SystemInformationTable.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeToContents)
        ...
        self.tabWidget.addTab(self.ConnectionInformationTab, "")
        ...
        self.shellTextViewer = QtWidgets.QTextEdit(self.tab)
        ...
        self.shellInput = QtWidgets.QLineEdit(self.tab)
    ...
    def retranslateUi(self, ClientInspectionWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.ConnectionInformationTab),
        ...
        self.shellInput.setPlaceholderText(_translate("ClientInspectionWindow", "Enter a command..."))

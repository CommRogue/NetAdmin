...
class MainWindow(MainWindowUI, MainWindowBase):
    ...
    def __init__(self, parent=None):
        ...
        central_dock_area.setAllowedAreas(QtAds.DockWidgetArea.RightDockWidgetArea)
        ...
        table_dock_widget.resize(250, 150)
        table_dock_widget.setMinimumSize(200, 150)
        table_area = self.dock_manager.addDockWidget(QtAds.DockWidgetArea.BottomDockWidgetArea, table_dock_widget,
                                                     table_area)
        self.menuView.addAction(table_dock_widget.toggleViewAction())
